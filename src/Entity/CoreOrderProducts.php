...
class CoreOrderProducts
{
     ...
     * @var string
     *
     * @ORM\Column(name="sku", type="string", length=60, nullable=false)
     */
    private $sku;
     ...
     * @var string
     *
     * @ORM\Column(name="brand", type="string", length=60, nullable=false)
     */
    private $brand;
     ...
     * @var float
     *
     * @ORM\Column(name="real_price", type="float", precision=10, scale=0, nullable=false)
     */
    private $realPrice;
