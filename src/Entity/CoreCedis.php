...
class CoreCedis
{
     ...
     * @var integer
     *
     * @ORM\Column(name="cedis_id", type="integer", nullable=false)
     */
    private $cedisId;
     ...
     * @var string
     *
     * @ORM\Column(name="names_cedis", type="string", length=255, nullable=false)
     */
    private $namesCedis;
     ...
     * @var integer
     *
     * @ORM\Column(name="ext_number", type="integer", nullable=false)
     */
    private $extNumber;
     ...
     * @var string
     *
     * @ORM\Column(name="telephone", type="string", length=18, nullable=false)
     */
    private $telephone;
