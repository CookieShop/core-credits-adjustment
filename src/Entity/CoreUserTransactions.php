 ...
 * @ORM\Entity(repositoryClass="Adteam\Core\Credits\Adjustment\Repository\CoreUserTransactionsRepository")
 */
class CoreUserTransactions
{
     ...
     * @var integer
     *
     * @ORM\Column(name="correlation_id", type="integer", nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="balance_snapshot", type="integer", nullable=false)
     */
